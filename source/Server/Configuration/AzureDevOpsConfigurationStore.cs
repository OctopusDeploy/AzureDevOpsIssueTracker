...
{
    internal class AzureDevOpsConfigurationStore : ExtensionConfigurationStore<AzureDevOpsConfiguration>,
        IAzureDevOpsConfigurationStore
    {
        ...
        public SensitiveString? GetPersonalAccessToken()
        {
            return GetProperty(doc => doc.PersonalAccessToken);
        }

        public void SetPersonalAccessToken(SensitiveString? value)
        {
            SetProperty(doc => doc.PersonalAccessToken = value);
        }
